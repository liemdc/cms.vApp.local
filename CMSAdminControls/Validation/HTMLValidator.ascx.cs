...
public partial class CMSAdminControls_Validation_HTMLValidator : DocumentValidator
{
    ...
    public string ValidatorURL
    {
        get
        {
            ...
            {
                mValidatorURL = DataHelper.GetNotEmpty(SettingsHelper.AppSettings["CMSValidationHTMLValidatorURL"], DEFAULT_VALIDATOR_URL);
            }
    ...
    private void SetupControls()
    {
        ...
        else
        {
            ...
            query = string.Format("?datakey={0}&docid={1}", Server.UrlEncode(ResultKey), Node.DocumentID);
