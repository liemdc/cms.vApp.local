...
<%#IfEmpty(Eval("SKUImagePath"), EcommerceFunctions.GetProductImage(Eval("SKUImagePath"), 200, Eval("SKUName")), "<a href='" + ResolveUrl((Eval("SKUImagePath")).ToString()) + "' target='_blank'>" + EcommerceFunctions.GetProductImage(Eval("SKUImagePath"), 200, Eval("SKUName")) + "</a>")%>
</td>
<td>
