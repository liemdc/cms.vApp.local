        ...
        <Templates>
            <DetailRow>
                <dx:ASPxGridView ID="GvLevelAA" ClientInstanceName="GvLevelAA" runat="server" DataSourceID="OdsGvLevelAA" KeyFieldName="ProjectTaskID" Width="100%" 
                    ...
                    OnBeforePerformDataSelect="GvLevelAA_BeforePerformDataSelect" OnHtmlDataCellPrepared="GvLevelAA_HtmlDataCellPrepared" OnStartRowEditing="GvLevelAA_StartRowEditing" OnFillContextMenuItems="GvLevelAA_FillContextMenuItems">
                    <Columns>                        
                        <dx:GridViewDataTextColumn EditFormSettings-VisibleIndex="1" FieldName="ProjectTaskMoldCode" Caption="Mã số khuôn" ReadOnly="true" Width="200" />
                        ...
                        <dx:GridViewDataTextColumn EditFormSettings-VisibleIndex="9" FieldName="ProjectTaskDeadline" Caption="Ngày xuất hàng" ReadOnly="true" PropertiesTextEdit-DisplayFormatString="dd/MM/yyyy HH:mm" EditFormSettings-Visible="False" Width="120"/>
                        <dx:GridViewDataDateColumn EditFormSettings-VisibleIndex="10" FieldName="ProcessExpectedCompletion" Caption="Giờ nhận dự kiến" Width="120">
                        ...
                        <dx:GridViewDataSpinEditColumn EditFormSettings-VisibleIndex="13" FieldName="ProcessExpectedTime" Caption="Tg gia công thực tế" Width="138">
                            <PropertiesSpinEdit DecimalPlaces="2" NumberType="Float" DisplayFormatString="{0} giờ.">
                                <ValidationSettings Display="Dynamic" RequiredField-IsRequired="true" RequiredField-ErrorText="Data is required." />
                            </PropertiesSpinEdit>
                        </dx:GridViewDataSpinEditColumn>
                        ...
                        <dx:GridViewDataMemoColumn EditFormSettings-VisibleIndex="24" FieldName="ProcessNotes" Caption="Ghi chú:" PropertiesMemoEdit-Rows="2" EditFormSettings-ColumnSpan="2" Width="480" MinWidth="255" />
                    </Columns>
                    ...
                    <Settings VerticalScrollBarMode="Hidden" HorizontalScrollBarMode="Visible" />
                    <SettingsBehavior EnableRowHotTrack="true" />                    
