...
<frameset border="0" rows="<%= TabsBreadFrameHeight %>, *" id="rowsFrameset">
    <frame name="wfStepMenu" src="Workflow_Step_Header.aspx?workflowstepid=<%=QueryHelper.GetInteger("workflowstepid", 0)%> "
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="wfStepContent" src="Workflow_Step_General.aspx?workflowstepid=<%=QueryHelper.GetInteger("workflowstepid", 0)%> "
