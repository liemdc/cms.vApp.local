...
<frameset border="0" rows="<%= TabsBreadHeadFrameHeight %>, *" id="rowsFrameset">
    <frame name="menu" src="Header.aspx?inlinecontrolid=<%=QueryHelper.GetInteger("inlinecontrolid", 0)%> "
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="content" src="General.aspx?inlinecontrolid=<%=QueryHelper.GetInteger("inlinecontrolid", 0)%>&saved=<%=QueryHelper.GetInteger("saved", 0)%> "
