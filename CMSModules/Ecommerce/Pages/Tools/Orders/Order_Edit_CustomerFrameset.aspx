...
<frameset border="0" rows="<%= TabsFrameHeight %>, *" id="rowsFrameset">
    <frame name="CustomerHeader" src="../Customers/Customer_Edit_Header.aspx?customerid=<%=QueryHelper.GetInteger("customerid", 0)%>&showtitle=1&hidebreadcrumbs=1"
        frameborder="0" scrolling="no" noresize="noresize" />
    <frame name="CustomerContent" src="../Customers/Customer_Edit_General.aspx?customerid=<%=QueryHelper.GetInteger("customerid", 0)%>"
        frameborder="0" />
