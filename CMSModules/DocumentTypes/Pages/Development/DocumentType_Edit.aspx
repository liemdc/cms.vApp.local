...
<frameset border="0" rows="<%= TabsBreadHeadFrameHeight %>, *" id="rowsFrameset">
    <frame name="menu" src="DocumentType_Edit_Header.aspx?documenttypeid=<%=QueryHelper.GetInteger("documenttypeid", 0) %> "
        scrolling="no" frameborder="0" noresize />
    <frame name="content" src="DocumentType_Edit_General.aspx?documenttypeid=<%=QueryHelper.GetInteger("documenttypeid", 0) %> "
