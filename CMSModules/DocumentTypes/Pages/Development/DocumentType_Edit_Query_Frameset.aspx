...
<frameset border="0" rows="<%=mHeight %>, *" id="rowsFrameset">
    <frame name="q_edit_menu" src="DocumentType_Edit_Query_Header.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString()) %>"
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="q_edit_content" src="DocumentType_Edit_Query_Edit.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString()) %>"
        frameborder="0" />
