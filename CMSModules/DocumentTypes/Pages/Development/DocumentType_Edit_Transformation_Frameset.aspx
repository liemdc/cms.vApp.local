...
<frameset border="0" rows="<%=mHeight %>, *" id="rowsFrameset">
    <frame name="t_edit_menu" src="DocumentType_Edit_Transformation_Header.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString())%>"
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="t_edit_content" src="DocumentType_Edit_Transformation_Edit.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString()) %>"
        frameborder="0" />
