...
<frameset border="0" rows="<%=mHeight %>, *" id="rowsFrameset">
    <frame name="hierarchicalheader" scrolling="no" noresize="noresize" frameborder="0"
         id="frameHeader" src="HierarchicalTransformations_Header.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString()) %>" />
    <frame name="content" frameborder="0" noresize="noresize" scrolling="yes"  src="HierarchicalTransformations_Transformations.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString()) %>"
        id="content" />
