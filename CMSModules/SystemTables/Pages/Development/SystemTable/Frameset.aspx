...
<frameset border="0" rows="<%= TabsBreadFrameHeight %>, *" id="rowsFrameset">
    <frame name="menu" src="Header.aspx?classid=<%= QueryHelper.GetInteger("classid", 0) %> "
        scrolling="no" frameborder="0" noresize />
    <frame name="content" src="Edit_Fields.aspx?classid=<%= QueryHelper.GetInteger("classid", 0) %> "
