...
<frameset border="0" rows="<%= TabsBreadFrameHeight %>, *" id="rowsFrameset">
    <frame name="Menu" src="NewsletterTemplate_Header.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString())%>"
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="Content" src="NewsletterTemplate_Edit.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString())%>"
