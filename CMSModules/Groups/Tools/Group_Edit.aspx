...
<frameset border="0" rows="<%= TabsBreadHeadFrameHeight %>, *" id="rowsFrameset">
    <frame name="menu" src="Group_Edit_Header.aspx?groupID=<%=QueryHelper.GetInteger("groupID", 0) %> "
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="content" src="Group_Edit_General.aspx?groupID=<%=QueryHelper.GetInteger("groupID", 0)%> "
