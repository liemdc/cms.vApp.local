...
<frameset border="0" rows="35,*" runat="server" id="rowsFrameset">
    <frame name="webpartlayoutheader" frameborder="0" noresize="noresize" scrolling="no"
         id="frameHeader" src="WebPartProperties_layout_frameset_header.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString())%>" />
    <frame name="webpartlayoutcontent" frameborder="0" noresize="noresize" 
         id="frameContent" src="webpartproperties_layout.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString())%>" />
