...
<frameset border="0" rows="<%= TabsBreadFrameHeight %>, *" id="rowsFrameset">
    <frame name="Header" src="WebPart_Edit_Layout_Header.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString())%>"
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="Content" src="WebPart_Edit_Layout_Edit.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString())%>"
