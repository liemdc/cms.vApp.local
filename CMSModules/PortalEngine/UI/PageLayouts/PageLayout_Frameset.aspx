...
<head id="Head1" runat="server" enableviewstate="false">
    ...
    <frame name="pl_edit_menu" src="PageLayout_Header.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString()) %>"
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="pl_edit_content" src="PageLayout_Edit.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString()) %>"
        frameborder="0" />
