...
<frameset border="0" rows="<%=mHeight %>, *" id="rowsFrameset">
    <frame name="Menu" src="CssStylesheet_Header.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString())%>"
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="Content" src="CssStylesheet_General.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString())%>"
