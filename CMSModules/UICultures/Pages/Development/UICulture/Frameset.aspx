...
<frameset border="0" rows="<%= TabsBreadFrameHeight %>, *" id="rowsFrameset">
    <frame name="menu" src="Header.aspx?uicultureid=<%=QueryHelper.GetInteger("UIcultureID", 0)%> "
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="content" src="../ResourceString/List.aspx?uicultureid=<%=QueryHelper.GetInteger("UIcultureID", 0)%>&update=<%=QueryHelper.GetInteger("update", 0)%>  "
