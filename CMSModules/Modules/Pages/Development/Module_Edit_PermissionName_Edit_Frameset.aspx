...
<frameset border="0" rows="<%= TabsBreadFrameHeight %>, *" id="rowsFrameset">
    <frame name="header" src="Module_Edit_PermissionName_Edit_Header.aspx?moduleId=<%=QueryHelper.GetInteger("moduleId", 0)%>&permissionId=<%=QueryHelper.GetInteger("permissionId", 0)%>"
