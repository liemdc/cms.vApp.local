...
<frameset border="0" rows="<%= TabsBreadHeadFrameHeight %>, *" id="rowsFrameset">
    <frame name="header" scrolling="no" noresize="noresize" frameborder="0"
         id="frameHeader" src="Header.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString()) %>" />
    <frame name="content" frameborder="0" noresize="noresize" scrolling="yes" src="Edit.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString()) %>"
        id="content" />
