...
<frameset border="0" rows="<%= TabsBreadFrameHeight %>, *" id="rowsFrameset">
    <frame name="customsettingscategorytabs" src="CustomSettingsCategory_Tabs.aspx?selectedtab=<%=mSelectedTab %>&treeroot=<%=QueryHelper.GetText("treeroot", "")%>&categoryid=<%=mTabsCategoryId%>&siteid=<%=QueryHelper.GetInteger("siteid", 0)%>"
