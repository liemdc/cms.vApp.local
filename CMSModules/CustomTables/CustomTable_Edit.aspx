...
<frameset border="0" rows="<%= TabsBreadHeadFrameHeight %>, *" id="rowsFrameset">
    <frame name="menu" src="CustomTable_Edit_Header.aspx?customtableid=<%=QueryHelper.GetInteger("customtableid", 0) %> "
        scrolling="no" frameborder="0" noresize />
    <frame name="content" src="CustomTable_Edit_General.aspx?customtableid=<%=QueryHelper.GetInteger("customtableid", 0)%> "
