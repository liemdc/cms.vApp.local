...
<frameset border="0" rows="<%= TabsBreadFrameHeight %>, *" id="rowsFrameset">
    <frame name="ctt_edit_menu" src="CustomTable_Edit_Transformation_Header.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString()) %>"
        scrolling="no" frameborder="0" noresize="noresize" />
    <frame name="ctt_edit_content" src="CustomTable_Edit_Transformation_Edit.aspx?<%=HTMLHelper.HTMLEncode(Request.QueryString.ToString()) %>"
        frameborder="0" />
