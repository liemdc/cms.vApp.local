...
public class ResourceHandler : IHttpHandler
{
    ...
    {
        ProcessFileRequest(context, JS_FILE_ARGUMENT, JS_FILE_EXTENSION, MimeTypeHelper.GetMimetype(JS_FILE_EXTENSION), ScriptHelper.ScriptMinificationEnabled);
    }
    ...
    /// <param name="contentType">Content type to use when sending a response</param>
    /// <param name="minificationEnabled">True, if the data should be minified, otherwise false</param>
    private static void ProcessFileRequest(HttpContext context, string queryArgument, string fileExtension, string contentType, bool minificationEnabled)
    {
    ...
    private static CMSOutputResource GetResource(CMSCssSettings settings, string name, bool cached)
    {
        ...
        // Minify
        MinifyResource(result, new CssMinifier(), CSSHelper.StylesheetMinificationEnabled && settings.EnableMinification, settings.EnableMinification);
