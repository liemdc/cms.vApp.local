...
config. BgColor         = '#fafafa' // Background colour (HTML colour value, in quotes)
...
function tt_MkTipSubDivs()
{
	...
	tt_aElt[0].innerHTML =
		(''
		+ (tt_aV[TITLE].length ?
			('<div id="WzTiTl" style="position:relative;z-index:10001;">'
			...
			+ '</tr></tbody></table></div>')
			: '')
		+ '<div id="WzBoDy" style="position:relative;z-index:10000;">'
...
function tt_Show()
{
	...
	css.zIndex = Math.max((window.dd && dd.z) ? (dd.z + 2) : 10000, 1010);
