...
</table>', '005a6c1c-a442-4229-ba5c-80f423dea704', '20111004 13:51:46', 1768)
...
INSERT INTO [CMS_AlternativeForm] ([FormID], [FormDisplayName], [FormName], [FormClassID], [FormDefinition], [FormLayout], [FormGUID], [FormLastModified], [FormCoupledClassID]) VALUES (129, N'Edit profile (MyDesk)', N'EditProfileMyDesk', 59, N'<form><field column="UserID" visible="false" dependsonanotherfield="false" /><field column="UserName" fieldcaption="{$general.username$}" dependsonanotherfield="false"><settings><controlname>viewsecuretext</controlname></settings></field><field column="FirstName" fieldcaption="{$general.firstname$}" dependsonanotherfield="false" /><field column="MiddleName" visible="false" dependsonanotherfield="false" /><field column="LastName" fieldcaption="{$general.lastname$}" dependsonanotherfield="false" /><field column="FullName" fieldcaption="{$general.fullname$}" allowempty="false" dependsonanotherfield="false"><settings><controlname>viewsecuretext</controlname></settings></field><field column="Email" fieldcaption="{$general.email$}" dependsonanotherfield="false"><settings><controlname>emailinput</controlname></settings></field><field column="UserPassword" visible="false" dependsonanotherfield="false" /><field column="PreferredCultureCode" fieldcaption="{$MyDesk.MyProfile.Culture$}" dependsonanotherfield="false"><settings><controlname>sitecultureselector</controlname></settings></field><field column="PreferredUICultureCode" fieldcaption="{$MyDesk.MyProfile.UICulture$}" dependsonanotherfield="false"><settings><controlname>uicultureselector</controlname></settings></field><field column="UserEnabled" visible="false" dependsonanotherfield="false" /><field column="UserIsEditor" visible="false" dependsonanotherfield="false" /><field column="UserIsGlobalAdministrator" visible="false" dependsonanotherfield="false" /><field column="UserIsExternal" visible="false" defaultvalue="false" dependsonanotherfield="false" /><field column="UserPasswordFormat" visible="false" dependsonanotherfield="false" /><field column="UserCreated" visible="false" dependsonanotherfield="false"><settings><editTime>false</editTime></settings></field><field column="LastLogon" visible="false" dependsonanotherfield="false"><settings><editTime>false</editTime></settings></field><field column="UserStartingAliasPath" visible="false" dependsonanotherfield="false" /><field column="UserGUID" visible="false" dependsonanotherfield="false" /><field column="UserLastModified" visible="false" dependsonanotherfield="false"><settings><editTime>false</editTime></settings></field><field column="UserLastLogonInfo" visible="false" dependsonanotherfield="false" /><field column="UserIsHidden" visible="false" defaultvalue="false" dependsonanotherfield="false" /><field column="UserVisibility" dependsonanotherfield="false" /><field column="UserIsDomain" dependsonanotherfield="false" /><field column="UserHasAllowedCultures" dependsonanotherfield="false" /><field column="UserSiteManagerDisabled" dependsonanotherfield="false" /><field column="UserSettingsID" visible="false" dependsonanotherfield="false" /><field column="UserNickName" fieldcaption="{$general.nickname$}" dependsonanotherfield="false" /><field column="UserPicture" visible="false" dependsonanotherfield="false" /><field column="UserSignature" fieldcaption="{$general.signature$}" controlcssclass="TextAreaField" dependsonanotherfield="false"><settings><size>200</size><rows>5</rows><cols>33</cols></settings></field><field column="UserURLReferrer" visible="false" dependsonanotherfield="false" /><field column="UserCampaign" visible="false" dependsonanotherfield="false" /><field column="UserMessagingNotificationEmail" fieldcaption="{$Messaging.NotificationEmail$}" dependsonanotherfield="false"><settings><controlname>emailinput</controlname></settings></field><field column="UserCustomData" visible="false" dependsonanotherfield="false" /><field column="UserRegistrationInfo" visible="false" dependsonanotherfield="false" /><field column="UserPreferences" visible="false" dependsonanotherfield="false" /><field column="UserActivationDate" visible="false" dependsonanotherfield="false" /><field column="UserActivatedByUserID" visible="false" dependsonanotherfield="false" /><field column="UserTimeZoneID" fieldcaption="{$general.timezone$}" dependsonanotherfield="false"><settings><controlname>timezoneselector</controlname></settings></field><field column="UserAvatarID" fieldcaption="{$general.avatar$}" dependsonanotherfield="false"><settings><controlname>useravatarselector</controlname></settings></field><field column="UserBadgeID" visible="false" dependsonanotherfield="false" /><field column="UserShowSplashScreen" fieldcaption="{$adm.user.lblusershowsplashscreen$}" defaultvalue="false" dependsonanotherfield="false"><settings><controlname>checkboxcontrol</controlname></settings></field><field column="UserActivityPoints" visible="false" dependsonanotherfield="false" /><field column="UserForumPosts" visible="false" dependsonanotherfield="false" /><field column="UserBlogComments" visible="false" dependsonanotherfield="false" /><field column="UserGender" fieldcaption="{$general.gender$}" dependsonanotherfield="false"><settings><controlname>radiobuttonscontrol</controlname><RepeatDirection>horizontal</RepeatDirection><Options><item value="1" text="{$General.Male$}" /><item value="2" text="{$General.Female$}" /></Options></settings></field><field column="UserDateOfBirth" fieldcaption="{$general.DateOfBirth$}" dependsonanotherfield="false"><settings><EditTime>False</EditTime></settings></field><field column="UserMessageBoardPosts" visible="false" dependsonanotherfield="false" /><field column="UserSettingsUserGUID" visible="false" dependsonanotherfield="false" /><field column="UserSettingsUserID" visible="false" dependsonanotherfield="false" /><field column="WindowsLiveID" dependsonanotherfield="false" /><field column="UserBlogPosts" visible="false" dependsonanotherfield="false" /><field column="UserWaitingForApproval" visible="false" dependsonanotherfield="false" /><field column="UserDialogsConfiguration" dependsonanotherfield="false" /><field column="UserDescription" dependsonanotherfield="false" /><field column="UserUsedWebParts" dependsonanotherfield="false" /><field column="UserUsedWidgets" dependsonanotherfield="false" /><field column="UserFacebookID" dependsonanotherfield="false" /><field column="UserAuthenticationGUID" dependsonanotherfield="false" /><field column="UserSkype" fieldcaption="Skype account" visible="true" dependsonanotherfield="false" /><field column="UserIM" fieldcaption="IM" visible="true" dependsonanotherfield="false" /><field column="UserPhone" fieldcaption="Phone number" visible="true" dependsonanotherfield="false" /><field column="UserPosition" dependsonanotherfield="false" /><field column="UserBounces" dependsonanotherfield="false" /></form>', N'<table cellspacing="2" cellpadding="2">
    <tbody>
        <tr>
...
</table>', '8815b022-8e63-4f96-9710-a901e35e04d2', '20110225 12:58:03', 1768)
