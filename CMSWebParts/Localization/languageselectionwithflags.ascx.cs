                    ...
                    if (documentCultureExists)
                    {
                        if (!((HideCurrentCulture) && (String.Compare(CMSContext.CurrentDocument.DocumentCulture, cultureCode, true) == 0)))
                        {
                            ...
                            if (ShowCultureNames)
                            {
                                ...
                                ltlHyperlinks.Text += "<a href=\"" + HTMLHelper.HTMLEncode(url) + "\">";
                            ...
                            {
                                ltlHyperlinks.Text += "<a href=\"" + HTMLHelper.HTMLEncode(url) + "\">" + "<img src=\"" + imgFlagIcon + "\" alt=\"" + HTMLHelper.HTMLEncode(cultureShortName) + "\" />";
