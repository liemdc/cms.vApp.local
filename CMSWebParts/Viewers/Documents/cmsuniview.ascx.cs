...
public partial class CMSWebParts_Viewers_Documents_cmsuniview : CMSAbstractWebPart
{
    ...
    public string ClassNames
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("Classnames"), uniView.ClassNames), uniView.ClassNames);
        }
        set
        {
    ...
    public string CategoryName
    {
        get
        {
            return ValidationHelper.GetString(this.GetValue("CategoryName"), uniView.CategoryName);
        }
        set
        {
    ...
    public string CultureCode
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("CultureCode"), uniView.CultureCode), uniView.CultureCode);
        }
        set
        {
    ...
    public string SiteName
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("SiteName"), uniView.SiteName), uniView.SiteName);
        }
        set
        {
    ...
    public string RelationshipName
    {
        get
        {
            return DataHelper.GetNotEmpty(ValidationHelper.GetString(GetValue("RelationshipName"), uniView.RelationshipName), uniView.RelationshipName);
        }
        set
        {
    ...
    public bool DelayedLoading
    {
        get
        {
            return ValidationHelper.GetBoolean(this.GetValue("DelayedLoading"), this.uniView.DelayedLoading);
        }
        set
        {
            this.SetValue("DelayedLoading", value);
            this.uniView.DelayedLoading = value;
        }
    }
    ...
    public bool UseHierarchicalOrder
    {
        get
        {
            return ValidationHelper.GetBoolean(this.GetValue("UseHierarchicalOrder"), this.uniView.UseHierarchicalOrder);
        }
        set
        {
            this.SetValue("UseHierarchicalOrder", value);
    ...
    protected void SetupControl()
    {
        ...
        else
        {
            ...
            uniView.DelayedLoading = this.DelayedLoading;
            ...
            uniView.SelectedItemTransformationName = this.SelectedItemTransformationName;
            uniView.SelectedFootertemTransformationName = this.SelectedFooterItemTransformationName;
            uniView.SelectedHeaderItemTransformationName = this.SelectedHeaderItemTransformationName;
